...
const appCss = "/jungle-juniors-adventure/assets/styles-CsZxz6sO.css";
...
function FallingLeaves() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "aria-hidden": true, className: "pointer-events-none fixed inset-0 z-[1]", children: leaves });
}
function Fireflies({ count = 18 }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "aria-hidden": true, className: "pointer-events-none absolute inset-0 overflow-hidden", children: flies });
}
function VineDivider() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "aria-hidden": true, className: "relative flex items-center justify-center py-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { viewBox: "0 0 600 40", className: "w-full max-w-3xl h-10 text-[color:var(--gold)]", fill: "none", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "path",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { fill: "currentColor", opacity: "0.85", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M150 20 q -6 -10 -16 -8 q 4 8 16 8 z" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M300 20 q 6 -12 18 -8 q -4 10 -18 8 z" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M450 20 q -6 -10 -16 -8 q 4 8 16 8 z" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "75", cy: "14", r: "2" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "525", cy: "26", r: "2" })
    ] })
  ] }) });
}
...
function WhatsAppFloat() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "a",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "h-7 w-7", fill: "currentColor" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute inset-0 rounded-full animate-ping bg-[#25D366] opacity-30" })
      ]
    }
  );
}
...
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "A nature-immersive summer camp for ages 7–15. 3 days, 30 kids, 100% outdoors. No screens. No parents. No limits."
      },
      { property: "og:title", content: "Jungle Juniors — Where Kids Go Wild" },
      {
...
function Index() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "relative min-h-screen overflow-x-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(FallingLeaves, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(WhatsAppFloat, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Hero, { scrollY }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(VineDivider, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(WhatSection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(VineDivider, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ActivitiesSection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(VineDivider, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(WhoSection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(VineDivider, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(RegisterSection, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(WhatsAppStrip, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Footer, {})
  ] });
}
function Hero({ scrollY }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative flex h-screen min-h-[640px] w-full items-center justify-center overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Fireflies, { count: 22 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        "aria-hidden": true,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "aria-hidden": true, className: "absolute left-6 top-24 text-3xl opacity-30", children: "🦋" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "aria-hidden": true, className: "absolute right-10 bottom-32 text-4xl opacity-25", children: "🦌" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "aria-hidden": true, className: "absolute left-1/3 bottom-16 text-2xl opacity-30", children: "🐦" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-4 text-xs uppercase tracking-[0.4em] text-[color:var(--gold)]", children: "Jungle Juniors • Est. Wild" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-5xl leading-[1.05] text-foreground md:text-7xl", children: [
            "Where Kids",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient-ember italic", children: "Go Wild" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mx-auto mt-6 max-w-xl text-base text-muted-foreground md:text-lg", children: "A nature-immersive camp experience unlike anything else." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-8 left-1/2 -translate-x-1/2 text-xs uppercase tracking-[0.3em] text-foreground/60", children: "Scroll ↓" })
  ] });
}
const WHAT = [
...
function WhatSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative mx-auto max-w-6xl px-6 py-20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "reveal mx-auto mb-14 max-w-2xl text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl md:text-5xl", children: "What is Jungle Juniors?" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-6 md:grid-cols-3", children: WHAT.map((w) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "reveal lift glass rounded-2xl p-8 text-center shadow-card",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4 text-5xl", children: w.icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mb-2 text-2xl text-[color:var(--gold)]", children: w.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: w.line })
        ]
      },
      w.title
    )) })
...
function ActivitiesSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative mx-auto max-w-6xl px-6 py-20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "reveal mx-auto mb-14 max-w-2xl text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-4xl md:text-5xl", children: "What They'll Do" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-sm text-muted-foreground", children: "Six days of doing. Zero days of scrolling." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-4 md:grid-cols-3 md:gap-6", children: ACTIVITIES.map((a) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Tag,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-3 text-4xl", children: a.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mb-1 text-lg text-foreground", children: a.title }),
...
function WhoSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative mx-auto max-w-4xl px-6 py-20 text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "reveal text-3xl leading-tight md:text-5xl", children: [
      "Ages 7–15.",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient-ember", children: "No screens. No parents. No limits." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reveal mt-12 flex flex-wrap items-center justify-center gap-4", children: [
      { icon: "📅", label: "3 Days" },
...
function RegisterSection() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "register", className: "relative mx-auto max-w-3xl px-6 py-24 text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Fireflies, { count: 10 }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "reveal text-xs uppercase tracking-[0.4em] text-[color:var(--gold)]", children: "Limited Spots" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "reveal mt-4 text-4xl md:text-5xl", children: "Spots fill fast." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "reveal mt-2 text-lg text-muted-foreground", children: "Secure yours today." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "a",
      {
        href: "#register",
...
function WhatsAppStrip() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      style: { background: "var(--gradient-ember)" },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-3xl text-[color:var(--ember-foreground)] md:text-4xl", children: "Got questions? We're one message away." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: "https://wa.me/919741698468",
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "relative px-6 py-12 text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl text-[color:var(--gold)]", children: "Jungle Juniors" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "Where kids go wild." }),
