...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BpKBy_dY.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-ZJKVIIi4.js"),
    import("./start-DH3hZI9R.js"),
...
var ROUTER_BASEPATH = "jungle-juniors-adventure";
var SERVER_FN_BASE = "/jungle-juniors-adventure/_serverFn/";
